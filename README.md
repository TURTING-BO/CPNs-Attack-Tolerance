...
This is a case study of "A Coloured Petri Nets Based Attack Tolerance Framework". When you run it, please make sure that you have installed CPNs Tools. CPNs Tools can be download from this url: http://cpntools.org/. There are many useful tutorials about how to use this powerful tool.
